...
\$secondaryEmails = [];
        ...
        return [
            ...
            'age' => null === \$this->age ? null : \$this->age->toScalar(),
...
CODE;
        ...
        $this->assertSame($expected, buildToArrayBody($definition, $constructor, new DefinitionCollection($definition, $userId, $userName, $email, $age), ''));
    }
